...
public class Day {
	...
	public void modified() {
		...
		button_1.setFont(new Font("±º∏≤", Font.PLAIN, 12));
		...
		label_2.setFont(new Font("±º∏≤", Font.PLAIN, 12));
